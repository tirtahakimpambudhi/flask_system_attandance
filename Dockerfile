...
ENV PATH="/app/venv/bin:$PATH" \
    ...
    SUPABASE_API_KEY=${{ shared.SUPABASE_API_KEY }} \
    SUPABASE_URL=${{ shared.SUPABASE_URL }} \
    SUPABASE_TABLE=${{ shared.SUPABASE_TABLE }} \
    SUPABASE_CONNECTION_STRING=${{ shared.SUPABASE_CONNECTION_STRING }} \
    TIME_OUT_CALL_API=${{ shared.TIME_OUT_CALL_API }} \
    TIME_INTERVAL_CALL_API=${{ shared.TIME_INTERVAL_CALL_API }} \
    UPLOAD_PATH=${{ shared.UPLOAD_PATH }} \
